...
@Service()
@BotcmdView({ name: 'reg', aliases: ['рег'] })
export default class RegView extends CommandView {
  public constructor(
  ...
  public async handler(
    ctx: Context,
    @ArgumentRequest() host: string,
    @ArgumentRequest() username: string,
    @ArgumentRequest() password: string,
  ) {
